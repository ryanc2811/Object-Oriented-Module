...
/**
 * This is the Behaviour for the diagonal movement of a fish
 * 
 * @author (Ryan Coles) 
 * @version (1.0)
 */
public class diagonalMovement implements IFishBehaviour
{
    ...
    public Vector3 getOrientation()
    {
     ...
     /**
     * Method Behaviour
     * Enacts the diagonal movement behaviour
     */
    public void Behaviour()
    {
        //move the fish along the x axis depending on the direction they are facing
       x+=Speed*facingDirection;
       //move the fish along the y axis depending on the direction they are facing
       y+=Speed*facingDirection;
       ...
       else if(x<=0.25)
       {
        ...
        //if y is greater than 7 then turn around and swim to the left
        //else if y is less than or equal to 1 then turn around and swim to the right
       if(y>=7.25)
       {
           //has hit the right side of the screen
           facingDirection=-1;
