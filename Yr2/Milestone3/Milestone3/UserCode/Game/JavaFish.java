...
/**
 * JavaFish initialises and spawns a JavaFish type pet in the game - it is a Facade. Use one for each pet.
 *
 * @author Marc
 * @version 0.1
 */
public class JavaFish implements ISpawnableFacade
{
    // instance constants
    ...
    // DECLARE a String to point to the JavaFish texture file, call it _texture:
    private static final String _texture = "textures/javaFish/JavaFish.png";
    
    // DECLARE a double to represent the scale of the JavaFish model, call it _scale, set it to 0.5:
    private static final double _scale = 0.15;
    
    // DECLARE a double to represent the positional value of the rhs of display window, call it _rhs, set it to 9.2:
    private static final double _rhs = 9.2;
    
    // DECLARE a double to represent the positional value of the lhs of display window, call it _lhs, set it to 0.7:
    private static final double _lhs = 0.7;
    
    
    // instance variables:
    // DECLARE an ISpawnable to store a reference to the ISpawnable this JavaFish controls, call it _spawnable
    ISpawnable _spawnable;
    
    // DECLARE a double to represent the speed of the JavaFish, call it _speed, set it to 0.1:
